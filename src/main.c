...
void ADC_Config()
{
	...
	ADC_InitStruct.ADC_ScanConvMode = ENABLE;			//COKLU ADC OKUMALARÝNDA TARAMA YAPMAK icin kullanilir.burada coklu okuma yapmiyoruz aslinda
...
void DMA_Config()
{
	...
	DMA_InitStruct.DMA_MemoryInc = ENABLE; 				// hafýzaya yazma iþleminde adresin surekli degismesini saglýyoruz
